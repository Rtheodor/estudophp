    ...
    //INSS E IRRF A SEREM SUBTRAIDOSN
    $inss = 608.45;
    $irrf = 1364.65;
    ...
    echo"<hr><h2>Usando estrutura de controle IF E ELSE </h2>";
    ...
    echo"<hr><h2>Usando IF, ELSEIF E ELSE </h2>";
    $notaa_aaluno = 0.3;
    ...
    foreach ($notas_do_filme as $notas_do_filme){
        ...
        // para pegar a media é soma todos os valores e dividir pela quantidade de itens que foram avaliados
